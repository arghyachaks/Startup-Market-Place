  ...
  renderCards() {
    ...
    const items = [
      ...
      },
      {
        ...
        description:'A request tries to withdraw money from the contract. Requests must be approved from approvers.',
      },
      {
        header: approversCount,
        meta:'Number of Approver',
